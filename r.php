...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] === 'delete') {
    ...
    $stmt->execute();
    echo "<p class='melding rood'>❌ Product $id verwijderd</p>";
}
...
<head>
    ...
    <style>
        ...
        input[type=submit]:hover, button.filter:hover {
            opacity: 0.85;
        }
        table {
            width: 100%;
...
<div class="topbar">
    <form method="get" class="zoekbalk">
        ...
        <select name="category">
            ...
            <?php
            foreach ($alleCategories as $cat) {
                $selected = ($cat === $catFilter) ? "selected" : "";
...
if ($result && $result->num_rows > 0) {
    echo "<table>";
    echo "<tr><th>Naam</th><th>Levrancier</th><th>Datum</th><th>Prijs</th><th>Voorraad</th><th>Foto</th><th>Acties</th></tr>";
